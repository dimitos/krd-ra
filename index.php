<?
    ...
    $smarty->assign([
        "page" => $page,
        "phone" => new Phone("71111234567"),
        "email" => new Email("krasnodar-ra@krasnodar-ra.com"),
        "address" => "г. Краснодар, п. Знаменский, ул. Светлая / ул. Природная",
        "object" => "ЖК «Родные просторы»",
        "meta" => new Meta(),
