...
{block modal}
    <div class="request-modal">
        <div class="request-modal__wrap">
            <h3 class="title title__section request-modal__title">Оставить заявку</h3>
            <form class="form request-modal__form">
                <div class="input__fields">
                    ...
                    <div class="input__fields-item">
                        <div class="input__fields-item-text">Комментарий</div>
                        <label class="input__field input__field-name">
                            <input class="input input-default input__white-white-black input-comment" type="text" placeholder="Введите ваши пожелания">
                        </label>
                    </div>
                </div>
